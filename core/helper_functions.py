...
def print_options():
    ...
    todolist_input_choices()


def todolist_input_choices():
    ...
    if choice == 1:
        ...
        new_todo_item()
        todolist_item_related_choices()
    else:
        todolist_item_independent_choices(choice)


def todolist_item_related_choices():
...
def todolist_item_independent_choices(choice):
    if choice == 4:
        fetch_todo_item()
